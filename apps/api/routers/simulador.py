...
# get_redis, _rate_limit y _get_real_ip viven en servicios/rate_limit.py
# (extraídos de aquí en la auditoría 2026-08-06 para reutilizarlos en
# routers/contacto.py sin duplicar la lógica). Alias locales para no tocar
