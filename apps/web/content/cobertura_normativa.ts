...
export const COBERTURA_NORMATIVA: Record<string, Record<string, CoberturaCombo>> = {
  andalucia: {
    acs: { nivelVerificacion: "verificada", estado: null, huecos: 10 },
  ...
  aragon: {
    ...
    fotovoltaica_autoconsumo: { nivelVerificacion: "generica", estado: "borrador_no_verificado", huecos: 8 },
  ...
  asturias: {
    acs: { nivelVerificacion: "generica", estado: "verificado_parcialmente", huecos: 8 },
    climatizacion_aerotermia: { nivelVerificacion: "generica", estado: "verificado_parcialmente", huecos: 5 },
  ...
  castilla_leon: {
    acs: { nivelVerificacion: "generica", estado: "borrador_no_verificado", huecos: 9 },
  ...
  madrid: {
    acs: { nivelVerificacion: "verificada_parcialmente", estado: "verificado_con_observaciones", huecos: 4 },
    climatizacion_aerotermia: { nivelVerificacion: "verificada_parcialmente", estado: "verificado_con_observaciones", huecos: 2 },
