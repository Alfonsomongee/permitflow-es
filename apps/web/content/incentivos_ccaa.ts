...
export type NivelVerificacion = "verified" | "pending_verification";
...
// Deducciones estatales pending_verifications — nivel_verificacion: "pending_verification"
export const deduccionesEstatalesRD19_2021 = {
  base_legal: "RD 19/2021 (Disposición derogatoria + Ley 10/2022)",
  nivel_verificacion: "pending_verification" as NivelVerificacion,
  deducciones: [
...
// Deducción autoconsumo RDL 7/2026 — nivel_verificacion: "pending_verification" (BOE 21/03/2026)
...
// Deducción IRPF 15% recarga IRVE — nivel_verificacion: "pending_verification" (RDL 7/2026)
...
// Tabla de deducciones autonómicas por CCAA — todas pending_verification
export const incentivosCAA: Record<string, IncentivosCAA> = {
  andalucia: {
    slug: "andalucia",
    deduccion_irpf_autonomica: { existe: false, fuente_url: null, nivel_verificacion: "pending_verification" },
  },
  aragon: {
    slug: "aragon",
    deduccion_irpf_autonomica: { existe: false, fuente_url: null, nivel_verificacion: "pending_verification" },
