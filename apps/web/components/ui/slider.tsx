      ...
      <SliderPrimitive.Control className="relative flex w-full touch-none items-center select-none data-[disabled]:opacity-50 data-[orientation=vertical]:h-full data-[orientation=vertical]:min-h-40 data-[orientation=vertical]:w-auto data-[orientation=vertical]:flex-col">
        ...
        >
          <SliderPrimitive.Indicator
            ...
            className="bg-gradient-primary select-none data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full"
          />
        </SliderPrimitive.Track>
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className="relative block size-4 shrink-0 rounded-full border-2 border-primary bg-white shadow-card transition-[box-shadow] select-none after:absolute after:-inset-2 hover:ring-4 hover:ring-primary/15 focus-visible:ring-4 focus-visible:ring-primary/20 focus-visible:outline-none active:ring-4 active:ring-primary/25 disabled:pointer-events-none disabled:opacity-50"
          />
        ))}
