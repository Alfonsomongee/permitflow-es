...
- ✅ Hecho: 7 (QW-01 plazos reales y QW-05 riesgo normativo visible — preexistentes, corrección de premisa; QW-02 radar normativo por cartera, QW-07 duplicar expediente, QW-08 filtro por tipo de actuación, QW-13 vista kanban, PREM-04 comparador de financiación — construidos en esta sesión)
- 🔶 Parcial: 3 (PREM-01 silencio administrativo, PREM-02 cartera de proyectos/kanban, EXP-05 subsanaciones) + DATA-06 panel de cartera
- ⬜ Pendiente: 30

Última actualización: 2026-08-22. Migración de PREM-02 aplicada en producción. Construido PREM-04 (comparador de financiación: préstamo vs. renting vs. contado, contra el coste de energía mensual real). Nota aparte: se recibió y verificó una auditoría normativa externa de Andalucía cuyos hallazgos más concretos (coste RADNE, referencia F-Gas, "26 reglas muertas", `nivel_verificacion` sin declarar) no se sostuvieron al contrastarlos con los ficheros reales -- no se ha aplicado ningún cambio a partir de ella salvo pendiente de confirmar la cita de RD 178/2021 en `andalucia/acs.json`.
